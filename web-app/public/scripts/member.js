  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if (data.error) {
        ...
        // update leaderboard
        $(".leaderboard-list").html(function() {
          var str = "";
          ...
          for (var i = 0; i < levelData.length; i++) {
            str =
              ...
              "</td>" +
              "<td>" +
              levelData[i].firstName +
              "</td>" +
              "<td>" +
              levelData[i].lastName +
              "</td>" +
              "<td>" +
              levelData[i].level +
              "</td>" +
              "<td>" +
              levelData[i].totalPoints +
              "</td>" +
              "</tr>";
          }
          return str;
